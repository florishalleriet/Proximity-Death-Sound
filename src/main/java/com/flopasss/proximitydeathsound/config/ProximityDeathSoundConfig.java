...
public class ProximityDeathSoundConfig {
    ...
    private static final Map<String, SoundSource> SOUND_SOURCE_BY_NAME =
        buildSoundSourceLookup();
    ...
    public static ProximityDeathSoundConfig load() {
        ...
        if (Files.exists(CONFIG_PATH)) {
            try {
                ...
                ProximityDeathSound.LOGGER.error(
    ...
    public void resolve() {
        ...
        if (holder.isPresent()) {
            ...
            ProximityDeathSound.LOGGER.warn(
        ...
        SoundSource resolved = SOUND_SOURCE_BY_NAME.get(
    ...
    public static boolean isValidSoundSource(String name) {
        return (
            name != null &&
            SOUND_SOURCE_BY_NAME.containsKey(name.toLowerCase(Locale.ROOT))
        );
    }
}
